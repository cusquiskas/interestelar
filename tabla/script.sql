...
CREATE TABLE `JUGADOR` (
  ...
  `JGD_FDESDE` date NOT NULL DEFAULT current_timestamp() COMMENT 'FECHA DE CREACIÓN DE LA CUENTA',
  `JGD_FVALIDA` date DEFAULT NULL COMMENT 'FECHA DE VALIDACIÓN DEL CORREO',
  `JGD_FACCESO` date NOT NULL DEFAULT current_timestamp() COMMENT 'FECHA DEL ÚLTIMO ACCESO',
...
--
ALTER TABLE `JUGADOR`
  MODIFY `JGD_JUGADOR` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID DEL JUGADOR';
